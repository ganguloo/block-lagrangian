...
# ==================== CONFIGURATION ====================
OUTPUT_FILE = "test_parallel.csv"

# (Mantén aquí tu INSTANCE_GRID, SEEDS y SOLVER_CONFIGS intactos)
INSTANCE_GRID = [
...
def worker_task(inst_conf, seed, solver_conf):
    """
